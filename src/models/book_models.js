...
module.exports = {
    ...
    getBookBy : (sql, callback) => {
        ...
        condb.query('SELECT  * FROM  tb_book AS a LEFT JOIN tb_category AS b ON a.id_category = b.id_category LEFT JOIN tb_shelf AS c ON a.id_shelf = c.id_shelf '+ sql,(err,result)=>{
            if(err) console.log(err)
